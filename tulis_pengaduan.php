    ...
    <form action="simpan_pengaduan.php" method="post" class="form-horizontal" enctype="multipart/form-data">
      ...
      <div class="form-group cols-sm-6">
       ...
       <div class="form-group cols-sm-6">
        ...
        <textarea class="form-control" rows="7" name="isi_laporan" required=""></textarea>
      </div>
       <div class="form-group cols-sm-6">
        <label>Unggah Foto</label>
        <input type="file" name="foto" class="form-control" accept=".jpg, .jpeg, .png, .gif"><font color="gray"> *tipe format foto hanya JPG,JPEG,PNG & GIF </font>
      </div>
