              ...
              <div class="col-lg-12">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">Selamat datang Admin/Petugas</h1><h2>Aplikasi Pelaporan Pengaduan Masyarakat</h2>
                  </div>
                  ...
                  <div class="text-center">
                    <a class="small" href="index.php">Masuk Sebagai Masyarakat</a>
                  </div>
                </div>
              </div>
            </div>
